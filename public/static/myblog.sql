...
-- ----------------------------
-- Table structure for tpblog_article
-- ----------------------------

-- 创建文章表
DROP TABLE IF EXISTS `tpblog_article`;
CREATE TABLE `tpblog_article` (
...
-- ----------------------------
-- Records of tpblog_article
-- ----------------------------
INSERT INTO `tpblog_article` VALUES ('17', '测试文章标题', 'zcs', '&lt;p&gt;测试文章内容&lt;img alt=&quot;zcs博客&quot; src=&quot;/Upload/image/ueditor/20150601/1433171136139793.jpg&quot; title=&quot;zcs博客&quot;/&gt;&lt;/p&gt;', '关键词,多个', '测试文章描述', '1', '0', '1', '1', '376', '1432649909', '28');

-- ----------------------------
-- Table structure for tpblog_article_pic
-- ----------------------------
-- 创建文章内图片的路径表
DROP TABLE IF EXISTS `tpblog_article_pic`;
CREATE TABLE `tpblog_article_pic` (
...
-- ----------------------------
-- Records of tpblog_article_pic
-- ----------------------------
INSERT INTO `tpblog_article_pic` VALUES ('11', '/Upload/image/ueditor/20150601/1433171136139793.jpg', '17');

-- ----------------------------
-- Table structure for tpblog_article_tag
-- ----------------------------
-- 创建标签表
DROP TABLE IF EXISTS `tpblog_article_tag`;
CREATE TABLE `tpblog_article_tag` (
  `aid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文章id',
  `tid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '标签id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tpblog_article_tag
-- ----------------------------
INSERT INTO `tpblog_article_tag` VALUES ('17', '20');

-- ----------------------------
-- Table structure for tpblog_tag
-- ----------------------------
-- 标签表的具体内容，标签名
DROP TABLE IF EXISTS `tpblog_tag`;
CREATE TABLE `tpblog_tag` (
...
-- ----------------------------
-- Records of tpblog_tag
-- ----------------------------
INSERT INTO `tpblog_tag` VALUES ('20', '测试标签');

-- ----------------------------
-- Table structure for tpblog_category
-- ----------------------------
-- 创建分类表，有个父级id用处还没想好，好像可以创建分类的子分类
DROP TABLE IF EXISTS `tpblog_category`;
CREATE TABLE `tpblog_category` (
...
-- ----------------------------
-- Records of tpblog_category
-- ----------------------------
INSERT INTO `tpblog_category` VALUES ('28', '测试分类', '测试分类关键词', '测试分类描述', '1', '0');


-- ----------------------------
-- Table structure for tpblog_comment
-- ----------------------------
-- 创建用户评论表，可以用于回复，父级id为回复对象，oauth_user表关联本站的表，暂时不需要
DROP TABLE IF EXISTS `tpblog_comment`;
CREATE TABLE `tpblog_comment` (
...
-- ----------------------------
-- Records of tpblog_comment
-- ----------------------------
INSERT INTO `tpblog_comment` VALUES ('19', '1', '1', '0', '17', '测试评论&lt;img src=&quot;/Public/emote/tuzki/t_0002.gif&quot; title=&quot;Love&quot; alt=&quot;白俊遥博客&quot;&gt;', '1445747059', '1', '0');
INSERT INTO `tpblog_comment` VALUES ('21', '1', '1', '19', '17', '测试回复', '1447943018', '1', '0');



-- ----------------------------
-- Table structure for tpblog_link
-- ----------------------------
-- 友情链接表
DROP TABLE IF EXISTS `tpblog_link`;
CREATE TABLE `tpblog_link` (
...
-- ----------------------------
-- Records of tpblog_link
-- ----------------------------
INSERT INTO `tpblog_link` VALUES ('2', '白俊遥博客', 'http://baijunyao.com', '1', '1', '0');


-- 用于后台管理员用户表
DROP TABLE IF EXISTS `tpblog_user`;
CREATE TABLE `tpblog_user` (
...
INSERT INTO `tpblog_user` VALUES ('2', 'admin', md5('admin'), 'admin', '1', unix_timestamp(now()),'127.0.0.1');
...
-- ----------------------------
-- Table structure for tpblog_oauth_user
-- ----------------------------
-- 关联本站的表，记录关联的人的信息和方式，暂时也不需要
DROP TABLE IF EXISTS `tpblog_oauth_user`;
CREATE TABLE `tpblog_oauth_user` (
...
-- ----------------------------
-- Table structure for tpblog_chat
-- ----------------------------
-- 碎言表，我暂时不需要
DROP TABLE IF EXISTS `tpblog_chat`;
...
-- ----------------------------
-- Records of tpblog_chat
-- ----------------------------
INSERT INTO `tpblog_chat` VALUES ('2', '1432827004', '测试随言碎语', '1', '0');
INSERT INTO `tpblog_chat` VALUES ('3', '1444529995', '测试碎言', '1', '0');


-- ----------------------------
-- Table structure for tpblog_config
-- ----------------------------
-- 这是博客的配置信息表，我暂时不需要
DROP TABLE IF EXISTS `tpblog_config`;
CREATE TABLE `tpblog_config` (
